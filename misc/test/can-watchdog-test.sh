...
do 
	...
	cat dev-05.txt | ssh -tt avena@172.16.254.5 sudo systemctl start can-watchdog.service
	...
	cat dev-05.txt | ssh -tt avena@172.16.254.5 sudo systemctl stop can-watchdog.service
	echo -e "Sleeping for 90s to let can messages stop"
	sleep 90
